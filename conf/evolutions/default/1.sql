...
(
    mb_user_id UUID NOT NULL,
    event_id  BIGINT   NOT NULL,
    CONSTRAINT mb_user_id_fk FOREIGN KEY (mb_user_id) REFERENCES auth.silhouette_users (id) ON DELETE CASCADE,
    CONSTRAINT event_id_fk FOREIGN KEY (event_id) REFERENCES app.events (id) ON DELETE CASCADE
);
